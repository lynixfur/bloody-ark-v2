...
function ServerList({servers, highpop_servers, site_settings}: any) {
    return (
        <>
            <Head>
                <title>Bloody ARK (PvE) - Servers</title>
            ...
            <div className="pt-[72px] w-full">
                <div className="h-full w-full" style={{ background: 'url(/pve.jpg)', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
